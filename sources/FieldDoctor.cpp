...
namespace pandemic {
    ...
    Player& FieldDoctor::treat(City city) {
        if (_player_board._connection_map[_current_city].count(city) < 1 && city != _current_city) {
        ...
        Color _target_city_color = _player_board._disease_map[city].first;
        if (_player_board._cures_discovered[_target_city_color]) {
